...
namespace RyanHellyer\UniqueHeaders\Vendor\Inpsyde\Modularity;

use RyanHellyer\UniqueHeaders\Vendor\Inpsyde\Modularity\Container\ContainerConfigurator;
use RyanHellyer\UniqueHeaders\Vendor\Inpsyde\Modularity\Container\PackageProxyContainer;
use RyanHellyer\UniqueHeaders\Vendor\Inpsyde\Modularity\Module\ExecutableModule;
use RyanHellyer\UniqueHeaders\Vendor\Inpsyde\Modularity\Module\ExtendingModule;
use RyanHellyer\UniqueHeaders\Vendor\Inpsyde\Modularity\Module\FactoryModule;
use RyanHellyer\UniqueHeaders\Vendor\Inpsyde\Modularity\Module\Module;
use RyanHellyer\UniqueHeaders\Vendor\Inpsyde\Modularity\Module\ServiceModule;
use RyanHellyer\UniqueHeaders\Vendor\Inpsyde\Modularity\Properties\Properties;
...
class Package
{
    ...
    private function handleConnectionFailure(string $packageName, string $reason, bool $throw): bool
    {
        ...
        do_action($this->hookName(self::ACTION_FAILED_CONNECT), $packageName, new \RyanHellyer\UniqueHeaders\Vendor\WP_Error('failed_connection', $message, $errorData));
        if ($throw) {
