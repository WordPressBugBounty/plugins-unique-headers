...
namespace RyanHellyer\UniqueHeaders\Vendor\Inpsyde\Modularity\Properties;
...
class PluginProperties extends BaseProperties
{
    ...
    {
        if (!function_exists('RyanHellyer\UniqueHeaders\Vendor\get_plugin_data')) {
    ...
    public function isActive(): bool
    {
        if ($this->isActive === null) {
            if (!function_exists('RyanHellyer\UniqueHeaders\Vendor\is_plugin_active')) {
                require_once ABSPATH . 'wp-admin/includes/plugin.php';
            }
    ...
    public function isNetworkActive(): bool
    {
        if ($this->isNetworkActive === null) {
            if (!function_exists('RyanHellyer\UniqueHeaders\Vendor\is_plugin_active_for_network')) {
                require_once ABSPATH . 'wp-admin/includes/plugin.php';
            }
